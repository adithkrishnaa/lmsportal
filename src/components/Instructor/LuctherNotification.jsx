...
import Navbar from "./LuctherNavbar";
import Search from "../../Searchbar/Lucthersearchbar";
...
const LuctherNotification = () => {
    ...
    const fetchNotifications = async () => {
      ...
      try {
        const response = await fetch(
          `https://course-compass-backend-zh7c.onrender.com/api/instructor/notifications`,
          {
            method: "GET",
            headers: {
  ...
  const deleteNotification = async (index) => {
    ...
    try {
      const response = await fetch(
        `https://course-compass-backend-zh7c.onrender.com/api/instructor/notifications/${index}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const markAsRead = async (index) => {
    ...
    try {
      const response = await fetch(
        `https://course-compass-backend-zh7c.onrender.com/api/instructor/notifications/${index}/read`,
        {
      ...
      <div className="pt-24">
        <div className="relative">
          <div className="left-7 absolute">
            <Link className="flex text-nowrap" to={"/luctherdashboard"}>

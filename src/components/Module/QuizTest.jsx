 ...
 const handleSubmitConfirm = () => {
   if (Object.keys(selectedAnswers).length === questions.length) {
     if (window.confirm("Are you sure you want to submit?")) {
       // Perform any additional submit actions here (e.g., API call)

       // Navigate to the QuizReport page after submission
       navigate("/quizreport"); // Adjust the path if necessary
     }
   } else {
    ...
    <div className="px-5 w-full font-inter">
      ...
      <div className="flex w-full justify-between place-content-between">
        <div>
          <div className="flex space-x-1 font-inter">
            ...
            <MdOutlineKeyboardArrowRight className="my-auto" size={24} />
            <h2 className="text-2xl font-semibold">Day #5</h2>
            <MdOutlineKeyboardArrowRight className="my-auto" size={24} />
        ...
        <div className="my-auto w-56 place-content-end">
          <p className="bg-[#FFC4C4] p-4 rounded-t-3xl">Total Questions: 30</p>
      ...
      <div className="mt-6 flex  justify-center">
        <div>
          ...
          <button
            className="px-4 py-2 w-60 justify-center text-center flex bg-[#007EFA] text-white rounded-lg"
        ...
        <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-60 flex justify-center items-center z-50">
          <div className="w-1/4 mx-auto px-2 py-5 space-y-4 rounded-3xl justify-center shadow-lg relative bg-white p-2">
            ...
            <p className=" text-center text-lg font-semibold">
              Are you sure you want to <br /> submit the quiz?
            </p>

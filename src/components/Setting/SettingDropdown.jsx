...
const Navigate = useNavigate();
  ...
  return (
    <>
      ...
      {/* Help Modal */}
      {showHelp && (
        <div className="fixed -top-4 bottom-0 h-full right-0 w-full min-h-screen bg-black bg-opacity-60 flex justify-center z-50 items-center">
      ...
      {showLogoutConfirm && (
        <div className="fixed -top-4 bottom-0  right-0 w-full min-h-screen bg-black bg-opacity-60 flex justify-center z-50 items-center">
